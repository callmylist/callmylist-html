...
export class MyCampaignsComponent implements OnInit {
  ...
  private createStage : boolean = false;

  private campaignType: number = 2;
  private nStep: number = 0;
  private text_campaign_process = 
    ["Campaign Type", "Campaign Name", "Select Area Code", "Compose Message", "Contact List", "Scheduling"];
  private sound_campaign_process = 
    ["Campaign Type", "Campaign Name", "Caller ID", "Audio Files", "Contact List", "Campaign Settings", "Scheduling"];
  private transfer : boolean = false;
  private useDefaultAudio : boolean = false;
  private doNotCall : boolean = false;
  private uploadContactList : boolean = false;
  private settingsCount: number = 0;
  public counterForm: FormGroup;
  private schedulingType : number = 0;
  private bCompleted : boolean = false;
